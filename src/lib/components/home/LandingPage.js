...
//   })
  ...
  return (
   <>
    ...
    <div className="hero-container animate__animated animate__fadeInUp className='outlet-container'" data-wow-delay=".3s">
    ...
    <div className="hero-text">
      ...
      <h5 style={{fontWeight:'bold',}}>
        ...
        No more spending hundreds on tutors <br/> <br />
    ...
    <Link href='/signup  '><Button color="info" >Register Interest</Button></Link>
    
      </div>
      
      <div 	className=" hero-image d-none d-lg-block"> 
      <button className='image-button' onClick={toggle}>
     <Image src={image1} style={{minWidth:'113%',maxWidth:'115%', Minheight:'90%'}} alt="Introduction Video"/>
     </button>
