function preprocessLatex(latex) {
    ...
    // Step 4.5: Remove the \begin{aligned} and \end{aligned} wrappers.
    // Use a global flag and also handle cases where the closing brace might be missing.
    ...
    // Step 7: Filter out any empty lines and any lines that still include the end{aligned} marker.
    lines = lines.filter(
