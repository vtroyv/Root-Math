...
const LandingFeatures = () => {
  return (
    ...
    <div className='landing-features'>
       ...
       <h4 style={{fontWeight:'bold'}}>Having been designed by those who know what it's like to struggle with Maths</h4>
       ...
       <img src={require('../styles/images/RootMath4.png')} alt="Why Root Math"/>
       </div>
       ...
       <Col>
        <div className='thought' style={{display:'flex', flexDirection:'column' }}>
            ...
            <h6 style={{fontWeight:'bold'}}>RootMath's got you covered!</h6>
        </div>
       </Col>
       <Col>
        <div className='thought' style={{display:'flex', flexDirection:'column' }}>
