...
const Courses = () => {
  return (
    <div className="courses-container">
        ...
        <h5 style={{fontWeight:'bold'}} > Is your course not covered?  Don't worry get in touch <Link to='/contact' style={{color:'#17a2b8'}}>here</Link> and we'll let you know which course matches your curriculum the best</h5>
...
>
  <CardBody>
    ...
    <CardSubtitle
      ...
      tag="h6"
    >
      <span style={{fontWeight:'bold', }}>Hundred's of questions</span>
    </CardSubtitle>
  </CardBody>
  <img
    alt="Card cap"
...
>
  ...
  <img
    alt="Card cap"
    src={require('../styles/images/lesson2.png')}
    width="100%"
  />
  <CardBody>
    <CardText>
