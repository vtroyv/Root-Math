...
const Faq = () => {
  return (
    ...
    <div className='faqs'>
        ...
        <h4 style={{textAlign:'center', margin:'1rem', paddingBottom:"2%",  fontWeight:'bold'}}>Here are some of our most frequently asked questions, if any of your questions aren't covered below, feel free to ask us directly <Link to='/contact' style={{color:'#17a2b8'}}>here</Link></h4>
        ...
        <UncontrolledCollapse toggler='#guarantee'>
          <Card style={{width:'20rem', height:'fit-content', margin:'1rem'}}> 
            <CardBody >
              ...
              <br />
              We are so confident in our platform's capabilities that any student that fulfills their given targets and still fails to achieve an A/A* will recieve a full 100% refund!
              You can read more about it <Link style={{color:' #17a2b8'}} to ='/features'>here </Link>
            </CardBody>
          </Card>
        ...
        <UncontrolledCollapse toggler='#year-12'>
          <Card style={{width:'20rem', height:'fit-content', margin:'1rem'}}> 
            <CardBody >
              Absolutely, although you don't have real exams in year 12, it's still the year where your performance is used to assign you the  predicted grades that you apply to university with. 
              <br />
              <br />
              Therefore it's still very important to get good grades in year 12 which is ever so easy with the help of RootMath!
        ...
        <UncontrolledCollapse toggler='#help-me'>
          <Card style={{width:'20rem', height:'fit-content', margin:'1rem'}}> 
            <CardBody >
              ...
              <br />
              <br />
              Having utilised an arsenal of world class study techinques we've created the perfect platform to help ALL students reach the highest grades. 
              If you'd like to find out more about the learning techniques integrated into RootMath you can do so <Link style={{color:'#17a2b8'}}> here</Link>
            </CardBody>
          </Card>
        ...
        <UncontrolledCollapse toggler='#tutor'>
          <Card style={{width:'20rem', height:'fit-content', margin:'1rem'}}> 
            <CardBody >
              RootMath provides students with an AI powered bot that you can ask any question you'd ask a real life tutor.
              <br />
              It's purpose is to help bridge the gap between online learning platforms, like ourselves, and standard traditional tution. 
              <br/>
              Our aim is to have students reap all the benefits of traditional tution at a fraction of a cost, if your interested in learning more you can do so <Link style={{color:'#17a2b8'}}>here </Link>
            </CardBody>
          </Card>
          ...
          <span style={{fontWeight:'bold', }}>What makes RootMath's lessons special? </span>
        ...
        <UncontrolledCollapse toggler='#videos'>
          <Card style={{width:'20rem', height:'fit-content', margin:'1rem'}}> 
            ...
            <br/> What's more is that our integrated quizzes and an AI-powered tutor, enable students to experience interactivity and accelerated learning through our lessons.
            </CardBody>
          </Card>
        ...
        <UncontrolledCollapse toggler='#content'>
          <Card style={{width:'20rem', height:'fit-content', margin:'1rem'}}> 
            <CardBody >
              ...
              To find out more visit our pricing page <Link style={{color:'#17a2b8'}}> here</Link>
            </CardBody>
          </Card>
